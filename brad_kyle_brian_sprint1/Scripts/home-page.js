...
function show_image(i) {
  ...
  function showImage(carouselId, i) {
    //Image carousel function copied and edited from above, serves the same purpose but I decided not to use the dots on this one.
  ...
  document.addEventListener("DOMContentLoaded", function () {
    // display list of hours of operation, address, contact, and details.
